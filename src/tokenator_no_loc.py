...
my_stops = ['>', '<', 'p', '/p', 's', 'o', 't', ', ', 'd', '444444',
            ...
            'potomac', 'york', 'stillaguamish', 'brugnato', 'lsdexce',
            'gauley', 'summersville', 'virginia', 'arkansas', 'chaffee',
            'buena', 'vista', 'salmon', 'colorado', 'idaho', 'montana', 'fork',
            'boise', 'delaware', 'ocoee', 'tennessee', 'rogue', 'blossom',
            'galice', 'picket', 'grave', 'chattooga', 'tugaloo', 'park',
            'grand', 'ranger', 'monument', 'utah', 'dinosaur', 'youghiogheny',
            'ohiopyle', 'loop', 'weitas', 'clearwater', 'payette',
            'jones', 'webkit', 'auto', 'watauga', 'salida', 'foster',
            'national', 'cottonwood']
