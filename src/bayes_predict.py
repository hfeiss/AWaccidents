...
def make_vectorizer():
    ...
    vectorizer.fit(X)
    joblib.dump(vectorizer, '/Users/hfeiss/dsi/capstone-2/models/bayes_vector.joblib')

vectorizer = joblib.load('/Users/hfeiss/dsi/capstone-2/models/bayes_vector.joblib')
...
death = [
'It could have been a good day of kayaking. The water levels '
...
medical = [
'There was a diabetic on our trip. He forgot his insulin. He '
...
injury = [
'It was the end of the day, and everyone was tired. The raft guide '
...
if __name__ == "__main__":
    ...
    vectorizer = joblib.load('/Users/hfeiss/dsi/capstone-2/models/bayes_vector.joblib')
    bayes = joblib.load('/Users/hfeiss/dsi/capstone-2/models/bayes.joblib')
